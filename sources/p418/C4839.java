...
/* renamed from: ﹳᵔ.ⁱʿ, reason: contains not printable characters */
/* loaded from: classes.dex */
public final class C4839 extends AbstractC0785 {
    public static final int CATALOGUE_NAME_FIELD_NUMBER = 5;
    private static final C4839 DEFAULT_INSTANCE;
    ...
    static {
        ...
        DEFAULT_INSTANCE = c4839;
        AbstractC0785.m3234(C4839.class, c4839);
    }
    ...
    public final Object mo3242(int i) {
        switch (AbstractC1702.m5411(i)) {
            ...
            case 1:
                return null;
            case 2:
                return new C0767(DEFAULT_INSTANCE, "\u0000\u0005\u0000\u0000\u0001\u0005\u0005\u0000\u0000\u0000\u0001Ȉ\u0002Ȉ\u0003\u000b\u0004\u0007\u0005Ȉ", new Object[]{"primitiveName_", "typeUrl_", "keyManagerVersion_", "newKeyAllowed_", "catalogueName_"});
            case 3:
                return new C4839();
            case 4:
                return new C4827(DEFAULT_INSTANCE, 1);
            case 5:
                return DEFAULT_INSTANCE;
            case C3789.STRING_SET_FIELD_NUMBER /* 6 */:
                InterfaceC0772 c0738 = PARSER;
                if (c0738 == null) {
                    synchronized (C4839.class) {
                        try {
                            c0738 = PARSER;
                            if (c0738 == null) {
                                c0738 = new C0738();
