...
/* renamed from: ﹳᵔ.ˑי, reason: contains not printable characters */
/* loaded from: classes.dex */
public final class C4812 extends AbstractC0785 {
    private static final C4812 DEFAULT_INSTANCE;
    ...
    static {
        ...
        DEFAULT_INSTANCE = c4812;
        AbstractC0785.m3234(C4812.class, c4812);
    }

    /* renamed from: יʻ, reason: contains not printable characters */
    public static void m10820(C4812 c4812) {
        c4812.ivSize_ = 16;
    }

    /* renamed from: ᐧⁱ, reason: contains not printable characters */
    public static C4808 m10821() {
        return (C4808) DEFAULT_INSTANCE.m3239();
    }

    /* renamed from: ﹳˑ, reason: contains not printable characters */
    public static C4812 m10822() {
        return DEFAULT_INSTANCE;
    }

    /* renamed from: ˈٴ, reason: contains not printable characters */
    public final int m10823() {
        return this.ivSize_;
    }
    ...
    public final Object mo3242(int i) {
        switch (AbstractC1702.m5411(i)) {
            ...
            case 3:
                return new C4812();
            case 4:
                return new C4808(DEFAULT_INSTANCE);
            case 5:
                return DEFAULT_INSTANCE;
            case C3789.STRING_SET_FIELD_NUMBER /* 6 */:
                InterfaceC0772 c0738 = PARSER;
                if (c0738 == null) {
                    synchronized (C4812.class) {
                        try {
                            c0738 = PARSER;
                            if (c0738 == null) {
                                c0738 = new C0738();
