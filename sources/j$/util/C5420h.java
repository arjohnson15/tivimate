...
class C5420h extends C5419g implements java.util.List, List {
    private static final long serialVersionUID = -7754090372962971524L;
    final java.util.List c;

    C5420h(java.util.List list) {
        super(list);
        this.c = list;
    }

    C5420h(java.util.List list, Object obj) {
        super(list, obj);
        this.c = list;
    }
    ...
    private Object readResolve() {
        ...
        return list instanceof RandomAccess ? new C5422j(list) : this;
    }
    ...
    public final void sort(java.util.Comparator comparator) {
        synchronized (this.b) {
            AbstractC5414b.w(this.c, comparator);
        }
    }
    ...
    public java.util.List subList(int i, int i2) {
        C5420h c5420h;
        synchronized (this.b) {
            c5420h = new C5420h(this.c.subList(i, i2), this.b);
        }
        return c5420h;
    }
}
