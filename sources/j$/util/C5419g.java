...
class C5419g implements java.util.Collection, Serializable, Collection {
    private static final long serialVersionUID = 3053995032091335093L;
    final java.util.Collection a;
    final Object b;

    C5419g(java.util.Collection collection) {
        this.a = (java.util.Collection) Objects.requireNonNull(collection);
        this.b = this;
    }

    C5419g(java.util.Collection collection, Object obj) {
        this.a = (java.util.Collection) Objects.requireNonNull(collection);
    ...
    public final java.util.stream.Stream parallelStream() {
        return Stream.Wrapper.convert(AbstractC5414b.u(this.a));
    }
    ...
    public final java.util.Spliterator spliterator() {
        return Spliterator.Wrapper.convert(AbstractC5414b.x(this.a));
    }
    ...
    public final java.util.stream.Stream stream() {
        return Stream.Wrapper.convert(AbstractC5414b.y(this.a));
    }
