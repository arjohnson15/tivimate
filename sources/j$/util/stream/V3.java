...
final class V3 extends AbstractC5477j0 {
    ...
    final Spliterator P(AbstractC5436b abstractC5436b, Spliterator spliterator) {
        return EnumC5450d3.ORDERED.s(abstractC5436b.K()) ? O(abstractC5436b, spliterator, new C5444c2(8)).spliterator() : new i4((j$.util.a0) abstractC5436b.X(spliterator), 1);
    }

    @Override // j$.util.stream.AbstractC5436b
    final InterfaceC5509p2 R(int i, InterfaceC5509p2 interfaceC5509p2) {
        return new U3(this, interfaceC5509p2);
    }
}
