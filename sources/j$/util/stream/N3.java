...
final class N3 extends AbstractC5464g2 {
    final /* synthetic */ Predicate m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    N3(AbstractC5469h2 abstractC5469h2, int i, Predicate predicate) {
    ...
    final Spliterator P(AbstractC5436b abstractC5436b, Spliterator spliterator) {
        return EnumC5450d3.ORDERED.s(abstractC5436b.K()) ? O(abstractC5436b, spliterator, new C5520s(29)).spliterator() : new j4(abstractC5436b.X(spliterator), this.m, 1);
    }
