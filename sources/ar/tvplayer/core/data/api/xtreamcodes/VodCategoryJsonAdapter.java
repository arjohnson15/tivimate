...
public final class VodCategoryJsonAdapter extends AbstractC5044 {
    ...
    public final AbstractC5044 f2153;

    /* renamed from: ˑʽ, reason: contains not printable characters */
    public final AbstractC5044 f2154;

    /* renamed from: ـﹶ, reason: contains not printable characters */
    public final C3759 f2155 = C3759.m8745("category_id", "category_name");

    public VodCategoryJsonAdapter(C5054 c5054) {
        this.f2153 = c5054.m11213(Integer.TYPE, C1038.f4437, "id");
        this.f2154 = c5054.m11213(String.class, Collections.singleton(new ﹳﹳ(5)), "name");
    }
    ...
    public final Object mo1390(AbstractC5050 abstractC5050) {
        ...
        while (abstractC5050.mo11191()) {
            int iMo11194 = abstractC5050.mo11194(this.f2155);
            if (iMo11194 == -1) {
                abstractC5050.mo11197();
                abstractC5050.mo11184();
            } else if (iMo11194 == 0) {
                num = (Integer) this.f2153.mo1390(abstractC5050);
                if (num == null) {
                    throw AbstractC2458.m6574("id", "category_id", abstractC5050);
                }
            } else if (iMo11194 == 1) {
                str = (String) this.f2154.mo1390(abstractC5050);
            }
        }
        abstractC5050.mo11198();
        if (num != null) {
            return new VodCategory(num.intValue(), str);
        }
    ...
    public final void mo1391(AbstractC5048 abstractC5048, Object obj) {
        ...
        this.f2153.mo1391(abstractC5048, Integer.valueOf(vodCategory.f2152));
        abstractC5048.mo11174("category_name");
        this.f2154.mo1391(abstractC5048, vodCategory.f2151);
